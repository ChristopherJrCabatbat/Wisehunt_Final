    ...
    @foreach ($transactions as $transaction)
        <div id="editModal{{ $transaction->id }}" class="modal editModal">
            <div class="modal-content">
                ...
                <form class="edit-modal-form" action="{{ route('staff.transactionUpdate', $transaction->id) }}"
                    method="POST">
                    @csrf
                    @method('PUT')
    ...
    <ul>
        ...
        <li>
            <div class="baba-container">
                ...
                <a class="sidebar active" href="{{ route('staff.transaction') }}">TRANSACTION</a>
            </div>
        </li>
        <li>
            <div class="baba-container">
    ...
    <div class="content">
        <div class="taas">
            ...
            <div class="new-generate">
                {{-- <form action="{{ route('staff.newTransaction', ['sort' => request('sort')]) }}"> --}}
            ...
            {{-- <form class="form-search" action="{{ route('staff.searchTransaction') }}" method="GET"> --}}
            ...
            <div>
                <div class="searchs">
                    ...
                    {{-- <a href="{{ route('staff.transaction') }}" class="cancel-search">Cancel search</a> --}}
                </div>
                {{-- </form> --}}
            </div>
